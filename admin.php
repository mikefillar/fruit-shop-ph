...
<body>
    <div class="grid grid-cols-2 px-32 py-10 w-screen h-screen">
        ...
        <div class="rounded border flex flex-col justify-center items-center gap-6">
            ...
            <p>Demo Account :</p>
            <p><b>Email : </b>testuser@email.com <b>Password : </b>testuser</p>
            <form action="login.php" method="post" class="flex flex-col gap-4 w-full px-6 mt-10">
                <input class="w-full px-4 py-2 border rounded" type="email" name="email" id="email" placeholder="your@email.com" required>
                <input class="w-full px-4 py-2 border rounded" type="password" name="password" id="password" placeholder="Password" required>
                <button name="login" class="px-4 py-2 rounded bg-orange-600 text-xl text-white font-bold">Login</button>
