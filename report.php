    ...
    <div class="grid grid-cols-12 w-screen h-screen">
        ...
        <nav class="col-span-2 bg-gray-700 flex flex-col justify-start items-center gap-10">
            ...
            <ul>
                ...
                <li><a class="active transition-all duration-200 ease-linear" href="report.php"><ion-icon name="chatbox-outline"></ion-icon><span>Report Bug</span></a></li>
            </ul>
        </nav>
        <!-- content -->
        <div class="col-span-10 px-10 ">
            ...
            <div class="grid grid-cols-2 gap-4">
                <h1 class="py-5 font-bold text-2xl text-gray-800">Report Bug</h1>
            </div>
            <div class="grid grid-cols-4 gap-4">
                <div class="col-span-2 flex justify-center items-center flex-col gap-4">
                    <form class="w-full grid gap-4" action="" method="">
                        <div class="flex flex-col">
                            <label for="full_name">Full Name</label>
                            <input class="border rounded px-4 py-2" type="text" name="full_name" id="full_name" placeholder="e.g 'Joe Shmoe'">
                        </div>
                        <div class="flex flex-col">
                            <label for="email">Email</label>
                            <input class="border rounded px-4 py-2" type="email" name="email" id="email" placeholder="your@emial.com">
                        </div>
                        <div class="flex flex-col">
                            <label for="subject">Subject</label>
                            <input class="border rounded px-4 py-2" type="text" name="subject" id="subject" placeholder="Enter subject">
                        </div>
                        <div class="flex flex-col">
                            <label for="message">Message</label>
                            <textarea name="message" rows="5" id="message" class="border rounded px-4 py-2" placeholder="Your message here..."></textarea>
                        </div>
                        <button type="submit" name="" class="bg-blue-400 py-2 rounded font-bold text-white">Send Report</button>
                    </form>
                </div>
                <div class="col-span-2">
                    <img src="/src/img/report.png" alt="construction">
                </div>
            </div>
        </div>
    </div>
